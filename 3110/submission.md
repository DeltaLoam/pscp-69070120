...
```text
calculate the fee for sending parcel

input: place to send and where it from and weight of the parcel
output: the fee
```
...
```text
get input of origin and destination and use if else to check origin and destination then use math to calculate fee then print it out
```
